...
import { IHero, ISetting } from '@/types/contentful';
...
export const Hero = ({ sys, fields }: IHero) => {
  ...
  return (
    <Experience
      ...
      experiences={parseExperiences(heroLayoutSetting)}
      component={(props: ISetting) => {
        const layout = props.fields.settingValue as keyof typeof layoutStyles;
        return (
                        ...
                        style={{
                          width:
                            (updatedHero.fields.image.fields.file.details.image
                              ...
                              Math.min(
                                590,
                                updatedHero.fields.image.fields.file.details
                                  .image.height
                              )) /
                            updatedHero.fields.image.fields.file.details.image
                              .height,
