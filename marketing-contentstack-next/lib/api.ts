...
export const getLandingPage = async (entryUrl: string) => {
  const response = await getEntryByWhereQuery({
    ...
    jsonRtePath: [
      ...
      'sections.feature.headline',
      'sections.feature.subline',
      'nt_modular_blocks_experiences.nt_experience_block.nt_variants.feature.headline',
      'nt_modular_blocks_experiences.nt_experience_block.nt_variants.feature.subline',
      'sections.pricing_table.headline',
      'sections.pricing_table.subline',
      'nt_modular_blocks_experiences.nt_experience_block.nt_variants.pricing_table.headline',
      'nt_modular_blocks_experiences.nt_experience_block.nt_variants.pricing_table.subline',
      'sections.pricing_table.pricing_plans.display_title',
