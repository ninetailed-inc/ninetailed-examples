...
export type SingularOrArrayBlock = SingularBlock | Entry[] | BaselineWithExperiencesEntry[]

export const hasExperiences = (entry: SingularBlock): entry is BaselineWithExperiencesEntry => {
  return (entry as BaselineWithExperiencesEntry).fields.nt_experiences !== undefined
}
